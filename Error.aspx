...
<head runat="server">
    <meta charset="UTF-8">
    <title>Pune Abrasives Pvt Ltd. - 404 Page</title>
    ...
    <main>
        ...
        <div runat="server" class="container">
          ...
          to go back to the homepage.                                   
                    ...
                    <asp:Label Font-Bold="true" ForeColor="Red" runat="server" ID="lblErrorMessage"></asp:Label><br />
                    <a href="../Admin/Dashboard.aspx" class="btn green">HOME</a>
                </div>
            </div>
        </div>
    </main>
