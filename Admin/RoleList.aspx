<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/WLSPLMaster.master" CodeFile="RoleList.aspx.cs" Inherits="Admin_RoleList" %>
            ...
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-9 col-md-10">
                          <h4 class="mt-4">&nbsp <b>ROLE LIST</b></h4>
                    </div>
                ...
                <div>
                    <div class="row">
                        <div class="table ">
                            <asp:GridView ID="GVUser" runat="server" CellPadding="4" DataKeyNames="RoleCode" PageSize="10" AllowPaging="true" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Role Code" HeaderStyle-CssClass="gvhead">
                                        <ItemTemplate>
                                            <asp:Label ID="Rolecode" runat="server" Text='<%#Eval("RoleCode")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Role Name" HeaderStyle-CssClass="gvhead">
                                        <ItemTemplate>
